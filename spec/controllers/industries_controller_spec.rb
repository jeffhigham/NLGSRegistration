  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved industry as @industry" do
        ...
        post :create, {:industry => { "company_id" => "invalid value" }}, valid_session
        assigns(:industry).should be_a_new(Industry)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested industry" do
        ...
        Industry.any_instance.should_receive(:update).with({ "company_id" => "1" })
        put :update, {:id => industry.to_param, :industry => { "company_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the industry as @industry" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Industry.any_instance.stub(:save).and_return(false)
        put :update, {:id => industry.to_param, :industry => { "company_id" => "invalid value" }}, valid_session
        assigns(:industry).should eq(industry)
      end
