  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved company as @company" do
        ...
        post :create, {:company => { "type" => "invalid value" }}, valid_session
        assigns(:company).should be_a_new(Company)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested company" do
        ...
        Company.any_instance.should_receive(:update).with({ "type" => "" })
        put :update, {:id => company.to_param, :company => { "type" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the company as @company" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Company.any_instance.stub(:save).and_return(false)
        put :update, {:id => company.to_param, :company => { "type" => "invalid value" }}, valid_session
        assigns(:company).should eq(company)
      end
