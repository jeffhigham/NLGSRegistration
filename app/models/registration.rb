class Registration < ActiveRecord::Base
  ...
  # has_many :pop_spaces, dependent: :destroy
  # accepts_nested_attributes_for :pop_spaces, allow_destroy: true

  # has_many :prototype_spaces, dependent: :destroy
  # accepts_nested_attributes_for :prototype_spaces, allow_destroy: true
