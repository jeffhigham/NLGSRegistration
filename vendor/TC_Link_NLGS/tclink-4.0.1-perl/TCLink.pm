...
this document and can be found in the web developers guide.  HTML and PDF
versions of the documentation can be found as part of the distribution
or in the Downloads section at https://vault.trustcommerce.com.
...
Johnny Luong, johnny@trustcommerce.com
